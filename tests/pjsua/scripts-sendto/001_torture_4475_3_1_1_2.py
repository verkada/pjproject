...
complete_msg = """!interesting-Method0123456789_*+`.%indeed'~ sip:1_unusual.URI~(to-be!sure)&isn't+it$/crazy?,/;;*:&it+has=1,weird!*pas$wo~d_too.(doesn't-it)@example.com SIP/2.0
...
sendto_cfg = sip.SendtoCfg(
    "RFC 4475 3.1.1.2", "--null-audio --auto-answer 200", "", 405, complete_msg=complete_msg
)
